...
fn gen_coverage(
    ...
    docker_exec("../configure --enable-zmq --with-incompatible-bdb --enable-lcov CC=clang CXX=clang++ LCOV_OPTS='--rc branch_coverage=1 --ignore-errors mismatch,inconsistent'");
