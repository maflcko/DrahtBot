...
def setup():
    ...
    subprocess.check_call(['git', 'checkout', 'fafa06d9b5df590123922456aad2e72641214e4a'])
...
def build():
    ...
    if args.linux:
        ...
        subprocess.call('mv var/build.log ../bitcoin-binaries/'+args.version+'/linux-build.log', shell=True)
    ...
    if args.windows:
        ...
        subprocess.call('mv build/out/bitcoin-*-win-unsigned.tar.gz inputs/', shell=True)
        subprocess.call('mv build/out/bitcoin-*.zip build/out/bitcoin-*.exe build/out/src/bitcoin-*.tar.gz ../bitcoin-binaries/'+args.version, shell=True)
        subprocess.call('mv result/*-win-*-res.yml ../bitcoin-binaries/'+args.version, shell=True)
        subprocess.call('mv var/build.log ../bitcoin-binaries/'+args.version+'/win-build.log', shell=True)
    ...
    if args.macos:
        ...
        subprocess.call('mv build/out/bitcoin-*-osx-unsigned.tar.gz inputs/', shell=True)
        subprocess.call('mv build/out/bitcoin-*.tar.gz build/out/bitcoin-*.dmg build/out/src/bitcoin-*.tar.gz ../bitcoin-binaries/'+args.version, shell=True)
        subprocess.call('mv result/*-osx-*-res.yml ../bitcoin-binaries/'+args.version, shell=True)
        subprocess.call('mv var/build.log ../bitcoin-binaries/'+args.version+'/osx-build.log', shell=True)
